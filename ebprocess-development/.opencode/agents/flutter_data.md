...
- CRITICAL ZERO-INTERACTION POLICY: You are a headless, autonomous background agent. NEVER ask the user interactive questions (e.g., "Would you like me to create these files?"). YOU must create any necessary files autonomously based on standard Flutter architecture.
