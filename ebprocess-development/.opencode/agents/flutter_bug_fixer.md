...
## Workflow
1. Locate the failure point from logs, tests, stack traces, or the reported file.
2. Reproduce or inspect the bug with the cheapest local check available.
3. Patch the narrowest slice that fixes the root cause.
